...
abstract class HighlightAssistantMixin<T> implements SelectionContainer<T>, HighlightProvider {
  @Deprecated('Use highlightFactoryRenderer instead as it allows tree-shaking.')
  final FactoryRenderer highlightFactoryRenderer = (_) => highlight.HighlightedValueComponentNgFactory;
  ...
  String get highlightQuery => options is Filterable ? (options as Filterable).currentQuery as String? ?? '' : '';
  ...
  @override
  List<HighlightedTextSegment> highlightOption(dynamic item) {
    _highlightAssistant ??=
        HighlightAssistant(optionHighlighter: optionHighlighter, matchFromStartOfWord: _highlightMatchFromStartOfWord);
    return _highlightAssistant!.highlightOption(highlightQuery, item, _highlightRenderer);
  }
}
